...
data_dir = '../../data'
org_data_dir = f"{data_dir}/generated_nprint"
out_put_data_dir = f"{data_dir}/replayable_generated_pcaps"
out_put_nprint_dir = f"{data_dir}/replayable_generated_nprints"
